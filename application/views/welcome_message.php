			...
			<div class="container">
				<div class="row fullscreen d-flex align-items-center">
					<div class="banner-content col-lg-7 col-md-6 justify-content-center ">
						<h6 class="text-uppercase">Jangan biarkan uang anda di rumah</h6>
						<h1>
							Menabunglah untuk Masa Depan Lebih Baik		
						</h1>
						<p class="text-white">
						...
						<a href="#" class="primary-btn header-btn text-uppercase mt-10">Mulai</a>
					</div>	
					<div class="banner-img col-lg-5 col-md-6 align-self-end">
						<img class="img-fluid" src="<?php echo base_url().'assets/img/banner-img.png'?>" alt="">
					</div>											
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-12 pb-50 header-text text-center">
						<h1 class="mb-10">Layanan Simpanan dengan Berbagai Keuntungan</h1>
						<p>
							Menjaga akan lebih baik daripada kehilangan..
						</p>
					</div>
				</div>						
				<div class="row">
			...
			<div class="container">
				<div class="row d-flex justify-content-center">
					<div class="menu-content pb-70 col-lg-8">
						<div class="title text-center">
							<h1 class="mb-10">Postingan Terakhir Kami</h1>
				...
				<div class="brand-wrap">
					<div class="row align-items-center active-brand-carusel justify-content-start no-gutters">
						<div class="col single-brand">
							<a href="#"><img class="mx-auto" src="<?php echo base_url().'assets/img/l1.png'?>" alt=""></a>
						</div>
						<div class="col single-brand">
							<a href="#"><img class="mx-auto" src="<?php echo base_url().'assets/img/l2.png'?>" alt=""></a>
						</div>
						<div class="col single-brand">
							<a href="#"><img class="mx-auto" src="<?php echo base_url().'assets/img/l3.png'?>" alt=""></a>
						</div>
						<div class="col single-brand">
							<a href="#"><img class="mx-auto" src="<?php echo base_url().'assets/img/l4.png'?>" alt=""></a>
						</div>
						<div class="col single-brand">
							<a href="#"><img class="mx-auto" src="<?php echo base_url().'assets/img/l5.png'?>" alt=""></a>
						</div>								
					</div>																			
				</div>
			</div>	
