                	...
                	<div class="row">
						<div class="col-lg-12">
                        	<div class="card">		
								<div class="card-body">
                                    <label>Profil Karyawan</label>
                                        <form class="form-horizontal form-material" method="post" action="<?php echo base_url().'admin/update_karyawan_p' ?>">
                                        	<?php foreach ($profil as $profil) { ?>
                                            <div class="form-group">
                                                <label class="col-md-12">Nama Lengkap</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="nama" value="<?php echo $profil->nama_karyawan;?>" class="form-control form-control-line">
                                                </div>
                                            </div>
                                            <div class="row">
	                                            <div class="col-md-6">
	                                                <div class="form-group row">
	                                                    ...
	                                                    <div class="col-md-9">
	                                                        <input type="text" name="tmp_lahir" value="<?php echo $profil->tmp_lahir_karyawan;?>" class="form-control form-control-line">
	                                                    </div>
	                                                </div>
	                                            </div>
	                                            <!--/span-->
	                                            <div class="col-md-6">
	                                                <div class="form-group row">
	                                                    ...
	                                                    <div class="col-md-9">
	                                                        <input type="date" name="tanggal" class="form-control" value="<?php echo $profil->tgl_lahir_karyawan;?>">
	                                                    </div>
	                                                </div>
	                                            </div>
	                                            <!--/span-->
	                                        ...
	                                        <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <select name="jk" class="form-control">
                                                        <option value="Laki-Laki" <?php if ($profil->jk_karyawan == "Laki-Laki")echo "selected;";?> >Laki-Laki</option>
                                                        <option value="Perempuan" <?php if ($profil->jk_karyawan == "Perempuan")echo "selected;";?> >Perempuan</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal form-material" method="post" action="<?php echo base_url().'admin/update_karyawan_a' ?>">
